                        ...
                        <div class="col-md-12">
                            <div class="post post-thumb">
                                ...
                                <div class="post-body">
                                    ...
                                    <h3 class="post-title"><a href="{{ route('menu.article') }}">Javascript :
                                            Prototype vs
                                            Class</a></h3>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="post">
                                ...
                                <div class="post-body">
                                    ...
                                    <h3 class="post-title"><a href="{{ route('menu.article') }}">Chrome Extension
                                            Protects
                        ...
                        <div class="col-md-6">
                            <div class="post">
                                ...
                                <div class="post-body">
                                    ...
                                    <h3 class="post-title"><a href="{{ route('menu.article') }}">Why Node.js Is The
                                            Coolest Kid
                        ...
                        <div class="col-md-12">
                            <div class="post post-row">
                                ...
                                <div class="post-body">
                                    ...
                                    <h3 class="post-title"><a href="{{ route('menu.article') }}">Ask HN: Does Anybody
                                            Still Use
                                            JQuery?</a></h3>
                        ...
                        <div class="col-md-12">
                            <div class="post post-row">
                                ...
                                <div class="post-body">
                                    ...
                                    <h3 class="post-title"><a href="{{ route('menu.article') }}">Microsoft’s
                                            TypeScript Fills A
                ...
                <div class="col-md-4">
                    ...
                    <div class="aside-widget">
                        ...
                        <div class="post post-widget">
                            ...
                            <div class="post-body">
                                <h3 class="post-title"><a href="{{ route('menu.article') }}">Tell-A-Tool: Guide To
                                        Web Design
                        ...
                        <div class="post post-widget">
                            ...
                            <div class="post-body">
                                <h3 class="post-title"><a href="{{ route('menu.article') }}">Pagedraw UI Builder
                                        Turns Your
